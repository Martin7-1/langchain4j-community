...
class LarkResponseLoggingInterceptor implements Interceptor {

    private static final Logger log = LoggerFactory.getLogger(LarkResponseLoggingInterceptor.class);
